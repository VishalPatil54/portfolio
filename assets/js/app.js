...
sr.reveal(".personaldetails", { delay: 400 });
...
sr.reveal(".skills_subtitle", {});
sr.reveal(".skills_text", {});
sr.reveal(".skills_row:nth-child(1)", { delay: 100 }); // First row
sr.reveal(".skills_row:nth-child(2)", { delay: 500 }); // Second row
sr.reveal(".skills_row:nth-child(3)", { delay: 900 }); // Third row
...
/*SCROLL EDUCATION AND EXPERIENCE*/
